'''
Nicholas Letarte
Calculating the average rainfall of Portland, ME with exception handling
'''


#gets average value to stop at 3 decimal places. 
...
#Obtains the average rainfall value based on the csv file
...
def main():
    ...
    try:
        ...
        portland_data = [[],[],[],[],[],[],[],[],[],[],[]] #setting up an array of arrays to capture precip data from 2010-2020 
